      ...
      <div className='homebody'>
              ...
              <div className='banner-btns'>
                ...
                <div>
                  <a href="" className=" findbtn">
                    <i className="fa-solid fa-paintbrush me-1"></i>Find Products
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className='quotes'>
          ...
          <div className='quotes-details'>
            <div className='quotes-logo'>FoodStuffs</div>
            <h3>Delivering happiness</h3>
            <h5>to your home</h5>
            <p>it is clear that more people are opting to have their groceries delivered to them; even grocery stores know that this is the future of the industry. If you own a local supermarket or are thinking of starting one, you need to advertise it effectively.</p>
            <div className='link-box'>
              <div onClick={seemore} className='link'>
              <i className="fa-solid fa-paintbrush me-1"></i>Show Products
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='great-service'>
          ...
          <div className='great-part-1'>
            ...
            <div><img src="Images/fruitlogo.webp" alt="" /></div>
          </div>
          ...
          <div className='great-part-2'>
            ...
            <div><img src="Images/veglogo.jpg" alt="" /></div>
          </div>
